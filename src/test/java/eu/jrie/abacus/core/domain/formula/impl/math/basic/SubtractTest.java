...
class SubtractTest extends MathFormulaTest {

    private final FormulaImplementation formula = new Subtract();
    ...
    Stream<DynamicTest> shouldCalculateAbsoluteValue() {
        ...
        ).map(testCase -> dynamicTest("should calculate difference of " + testCase.given(), () -> {
            // given
